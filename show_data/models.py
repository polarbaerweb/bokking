...
class Movie(models.Model):
	name_original = models.CharField(max_length=100, unique=True, null=False, default="undecided")
	name_translated = models.CharField(max_length=100, unique=True, null=False, default="undecided")
...
class Collection(models.Model):
	title = models.CharField(max_length=255, default="undecided", unique=True, null=False)
...
class Genre(models.Model):
	title = models.CharField(max_length=30, default="undecided", unique=True, null=False)
