const main__collection = document.querySelectorAll(".main__collection-movies");
...
main__collection.forEach(element => {
    ...
    const swiper_top_movies = new Swiper(element.querySelector('.main__collection-swiper'), {
